...
local count = 0
local frontier = {{n = 1, c = "shiny gold"}}
while #frontier > 0 do
  local it = table.remove(frontier)
  print("filling", it.n, it.c)
  for i, v in ipairs(rulesmap[it.c]) do
    print("adding", v.n * it.n, v.c)
    table.insert(frontier, {n = v.n * it.n, c = v.c})
    count = count + v.n * it.n
  end
end
