do
  ...
  local _dollardMonadkhq, join, join0
  _dollardMonadkhq = function(tmp)
    return {
      join = join(tmp),
      [">>="] = function(xs)
        return function(f)
  ...
  join = function(kiq)
    return function(klr)
      return join0(kiq, klr)
    end
  end
  join0 = function(kiq, klr)
    return _dollardMonadkhq(nil)[">>="](klr)(function(x)
      return x
    end)
  end
  local function _dollardExceptionmrv(tmp)
    return {
      from_exception = function(x)
        return Some(x)
      end,
      ["Exception$mhe"] = _Typeable_app({
        _1 = (function(tmp0)
          return _TypeRep({
            fingerprint = 272,
            name = "some"
  ...
  local function from_exception(nlm, nof)
  ...
  local function from_exception0(nlm)
    return function(nof)
      return from_exception(nlm, nof)
    end
  end
  local function _dollardExceptionnkp(tmp)
    return {
      from_exception = from_exception0(tmp),
      describe_exception = function(tmp0)
        return "User error: " .. tmp0
      end,
      ["Exception$mhe"] = (function(tmp0)
        return _TypeRep({
          fingerprint = 305,
          name = "user_error"
        })
      end)(),
      into_exception = function(nov)
        return MkSome(_dollardExceptionnkp(nil))(nov)
      end
    }
  end
  local function from_exception1(ojz, oms)
    local x = oms[2]
    local tmp = (function(tmp)
      return _TypeRep({
        fingerprint = 315,
  ...
  local function from_exception2(ojz)
    return function(oms)
      return from_exception1(ojz, oms)
    end
  end
  local function _dollardExceptionojc(tmp)
    return {
      ["Exception$mhe"] = (function(tmp0)
        return _TypeRep({
          fingerprint = 315,
      ...
      into_exception = function(oni)
        return MkSome(_dollardExceptionojc(nil))(oni)
      end,
  ...
  local function _dollardCategoryaeez(tmp)
    return {
      ["%"] = function(f)
        return function(g)
  ...
  local function _dollardArrowagfj(tmp)
    return {
      ["&&&"] = function(f)
        return function(g)
          return function(x)
      ...
      ["Arrow$aewr"] = _dollardCategoryaeez(nil)
    }
  end
  ...
  local function range_from_to(ydi, yet)
    local tmp = ydi["Ord$dvf"]
    return function(start)
      return function(finish)
        if ydi[">"](start)(finish) then
          return Nil
        end
  ...
  local function _dollarfoldr(vsg)
    return function(f)
      return function(z)
  ...
  local _dollardFoldablevrg, foldl1, foldl10
  _dollardFoldablevrg = function(tmp)
    return {
      ["Foldable$vae"] = function(f)
        return function(xs)
          local function cdi(xss)
            if xss.__tag ~= "Cons" then
              return Nil
            end
            local tmp0 = xss[1]
            return {
              { _1 = f(tmp0._1), _2 = cdi(tmp0._2) },
              __tag = "Cons"
            }
          end
          return cdi(xs)
  ...
  foldl1 = function(vsg)
    return function(wdw)
      return function(wdx)
        return foldl10(vsg, wdw, wdx)
      end
    end
  end
  foldl10 = function(vsg, wdw, wdx)
    local tmp = _dollardFoldablevrg(nil).foldl(function(m)
      return function(y)
        if m.__tag == "Some" then
          return Some(wdw(m[1])(y))
        end
        return Some(y)
      end
    end)(None)(wdx)
    ...
    return error(setmetatable(_dollardExceptionnkp(nil).into_exception("foldl1: empty structure"), {
      __tostring = _dollardExceptionmrv(nil).describe_exception
    }))
  end
  ...
  local function from_exception3(pae, pbx)
    local x = pbx[2]
    local tmp = (function(tmp)
      return _TypeRep({
        fingerprint = 753,
  ...
  local function from_exception4(pae)
    return function(pbx)
      return from_exception3(pae, pbx)
    end
  end
  local function _dollardExceptionoyh(tmp)
    return {
      ["Exception$mhe"] = (function(tmp0)
        return _TypeRep({
          fingerprint = 753,
      ...
      into_exception = function(pcn)
        return MkSome(_dollardExceptionoyh(nil))(pcn)
      end,
  ...
  local function put_line(str)
    ...
    wrap_nil(None, function(x)
      return error(setmetatable(_dollardExceptionoyh(nil).into_exception(x), {
        __tostring = _dollardExceptionmrv(nil).describe_exception
      }))
  ...
  local function balance(x, l, r0)
    if l.__tag == "E" then
      ...
      if r0.__tag == "E" then
        ...
        if rs > 3 * ls then
          if rr.__tag ~= "T" then
            return error(setmetatable(_dollardExceptionnkp(nil).into_exception("Impossible: balance T vs T, rs > delta * ls"), {
              __tostring = _dollardExceptionmrv(nil).describe_exception
            }))
          end
          local tmp5 = rr[1]._2
          ...
          if lr.__tag ~= "T" then
            return error(setmetatable(_dollardExceptionnkp(nil).into_exception("Impossible: balance T vs T, ls > delta * rs"), {
              __tostring = _dollardExceptionmrv(nil).describe_exception
            }))
          end
          local tmp5 = lr[1]
  ...
  local function alter(auak, f, k, tmp)
  ...
  local function _dollar_dot_28_29(auyb)
    return function(map)
      return function(key)
        local function _dollargo(x)
          ...
          local tmp1 = tmp._1
          local x0 = tmp1._2
          local tmp2 = auyb.compare(key)(tmp1._1)
        ...
        return error(setmetatable(_dollardExceptionnkp(nil).into_exception("Map.(.[]): no such key in map"), {
          __tostring = _dollardExceptionmrv(nil).describe_exception
        }))
      end
    end
  end
  local function _dollardIndexauwb(tmp)
    return {
      [".?()"] = function(map)
        return function(k)
          local function _dollargo(x)
  ...
  local function keys(tmp)
    ...
    local function cdi(xss)
      ...
      local tmp0 = xss[1]
      return {
        { _1 = tmp0._1._1, _2 = cdi(tmp0._2) },
        __tag = "Cons"
      }
    end
    return cdi(go(Nil, tmp))
  end
  local tmp = int_parser * (p(",") * int_parser) ^ 0
  local parser = lpeg.collect_list(Nil)(Cons)(Parser_coll_list({}))(tmp)
  local function costs(cueo, subs, positions)
    local tmp0 = scanl(function(tmp0)
      local tmp1 = tmp0._2
      local cost = tmp1._1
      local count = tmp0._1
      return function(newpos)
        local tmp2 = cueo[".?()"](subs)(newpos)
        if tmp2.__tag == "Some" then
          return {
            _1 = count + tmp2[1],
            _2 = { _1 = cost + count, _2 = newpos }
          }
        end
        return {
          _1 = count,
    ...
    return error(setmetatable(_dollardExceptionojc(nil).into_exception("tail"), {
      __tostring = _dollardExceptionmrv(nil).describe_exception
    }))
  end
  local function solve(initials)
    local tmp1 = {
      ...
      compare = function(fgq)
        return function(fgr)
          if fgq == fgr then return Eq end
          if fgq <= fgr then return Lt end
          return Gt
        end
      end,
      ["<"] = lt_int0,
    ...
    local subs = _dollardFoldablevrg(nil).foldr(function(k)
      return function(tmp2)
        return alter(tmp1, tmp0, k, tmp2)
      end
    end)(E)(initials)
    local tmp2 = keys(subs)
    local tmp3 = _dollardArrowagfj(nil)["&&&"](_dollardFoldablevrg(nil).foldl1(function(a)
      return function(b)
        if a < b then return a end
        return b
      end
    end))(_dollardFoldablevrg(nil).foldl1(function(a)
      return function(b)
        if a > b then return a end
        return b
      end
    ...
    local function zip_with_sat(xs, ys)
      ...
      return {
        {
          _1 = tmp5._1._2._1 + y._2._1,
          _2 = zip_with_sat(tmp5._2, ys0)
        },
        __tag = "Cons"
      }
    end
    local totalcost = zip_with_sat(costs(_dollardIndexauwb({
      compare = function(fgq)
        return function(fgr)
          if fgq == fgr then return Eq end
          if fgq <= fgr then return Lt end
      ...
      [">"] = gt_int0,
      [">="] = gte_int0
    }), subs, pos), loop0(Nil, costs(_dollardIndexauwb({
      compare = function(fgq)
        return function(fgr)
          if fgq == fgr then return Eq end
          if fgq <= fgr then return Lt end
    ...
    return _dollardFoldablevrg(nil).foldl1(function(a)
      return function(b)
        if a < b then return a end
        return b
      end
  ...
  local tmp0 = _dollardMonadkhq(nil)[">>="](read_input(nil))(function(s0)
